...
Enable the weather_routing plugin from within OpenCPN using _Options > Plugins_
...
To help new users when starting out, we have created a *Boat-test.xml*
...
_C:\ProgramData\opencpn\plugins\weather_routing\data\polars_ 
...
about this and refer to the default list in this manual above.
