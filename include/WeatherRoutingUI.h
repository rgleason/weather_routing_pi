 ...
 */
class RoutingTableDialogBase : public wxDialog {
private:
protected:
...
public:
  RoutingTableDialogBase(wxWindow* parent, wxWindowID id = wxID_ANY,
                         const wxString& title = _("Routing Table"),
                         const wxPoint& pos = wxDefaultPosition,
                         const wxSize& size = wxSize(-1, -1),
                         long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER);
  ~RoutingTableDialogBase();
};
